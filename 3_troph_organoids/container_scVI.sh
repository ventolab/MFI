...
bsub -q gpu-huge -M200000 \
  ...
  /bin/bash -c "HOME=$(mktemp -d) jupyter notebook --notebook-dir=/nfs/team292/aa22/scVI_related/202105_troph_organoids --NotebookApp.token='team292' --ip=0.0.0.0 --port=1234 --no-browser --allow-root"
