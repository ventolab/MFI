...
bsub -q gpu-normal -M200000 \
 ...
 -B /nfs,/lustre \
  ...
  /bin/bash -c "HOME=$(mktemp -d) jupyter notebook --notebook-dir=/nfs/team292/aa22/spatial_deconvolution_related/202110_MFI_Visium_and_organoids --NotebookApp.token='cell2loc' --ip=0.0.0.0 --port=1234 --no-browser --allow-root"
